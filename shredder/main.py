...
class Shredder:
    ...
    def load_images(self):
        ...
        # self.case = pathlib.Path(str("/mnt/Volume/Mega/LaureaMagistrale/CorsiSemestre/A2S1/MultudisciplinaryProject/pythostitcher/data/tentative/raw_images/fragment1.mrxs"))  # THIS IS FOR DEBUGGING
        print(self.case)
        print("str(self.case): " + str((self.case)))
        self.opener = mir.MultiResolutionImageReader()
        print("self.opener: " + str(self.opener))
        self.mir_image = self.opener.open(str(self.case))
        print("self.mir_image: " + str(self.mir_image))
        print("type(self.mir_image): " + str(type(self.mir_image)))  # this is for debugging
...
def main():
    ...
    print(cases[0])  # this is for debugging
    n1 = len(cases)
    ...
    # print(cases[0].name)  # this is for debugging
    n2 = len(cases)
